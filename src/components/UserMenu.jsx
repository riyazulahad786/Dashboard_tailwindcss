  ...
  return (
    <div className="relative mr-10">
      ...
      >
        ...
        <img src='/Riyaz.jpg' className='mx-4 w-8 h-8 rounded-full border-2 border-indigo-500' alt="User Avatar" /> 
        Riyaz
        <svg
      ...
      {isDropdownOpen && (
        ...
        >
          <div className="px-4 py-3 text-sm text-gray-900 dark:text-white">
            <div className="font-medium">Syed Riyaz</div>
            <div className="truncate">riyaz@flowbite.com</div>
          </div>
          <ul
